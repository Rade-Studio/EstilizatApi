    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<BaseResponse<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request)
        {
            ...
            SignInResult signInResult =
                await _signInManager.PasswordSignInAsync(user, request.Password, false, lockoutOnFailure: false);
        ...
        public async Task<BaseResponse<string>> ConfirmEmailAsync(string userId, string code)
        {
            ...
            if (result.Succeeded)
            {
                return new BaseResponse<string>(user.Id.ToString(),
                    message:
        ...
        public async Task<BaseResponse<string>> RegisterAsync(RegisterRequest request, string uri)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return new BaseResponse<string>(newUser.Id.ToString(),
        ...
        private async Task<string> GenerateRefreshToken(ApplicationUser user)
        {
            ...
            if (!result.Succeeded)
            {
                throw new ApiException($"An error occured while set refreshtoken.")
                    { StatusCode = (int)HttpStatusCode.InternalServerError };
            }
